...
for (intCtr in 1:10) {
    nnCost(vecMatrix=vecPass, nInputLayer=nInputLayer, nHiddenNodes=nHiddenNodes, 
           nFinalLabels=nFinalLabels, X=mtxX, y=mtxY, lambda=lambda
           )
}
proc.time() - startTime
...
nnListCG010 <- optim(par=vecPass, fn=nnCost, gr=nnGradient, nInputLayer=nInputLayer,
                     nHiddenNodes=nHiddenNodes, nFinalLabels=nFinalLabels,
                     X=mtxX, y=mtxY, lambda=lambda, control=list(maxit=10), method="CG"
                     )
proc.time() - startTime
...
nnListCG050 <- optim(par=vecPass, fn=nnCost, gr=nnGradient, nInputLayer=nInputLayer,
                     nHiddenNodes=nHiddenNodes, nFinalLabels=nFinalLabels,
                     X=mtxX, y=mtxY, lambda=lambda, control=list(maxit=50), method="CG"
                     )
proc.time() - startTime
...
nnListCG150 <- optim(par=vecPass, fn=nnCost, gr=nnGradient, nInputLayer=nInputLayer,
                     nHiddenNodes=nHiddenNodes, nFinalLabels=nFinalLabels,
                     X=mtxX, y=mtxY, lambda=lambda, control=list(maxit=150), method="CG"
                     )
proc.time() - startTime
...
# Print the post-optimization cost
nnCost(vecMatrix=nnListBFGS150$par, nInputLayer, nHiddenNodes, nFinalLabels, X=mtxX, y=mtxY, lambda)

# Plot the post-optimization gradients
plot(nnGradient(vecMatrix=nnListBFGS150$par, nInputLayer, nHiddenNodes, nFinalLabels, 
                X=mtxX, y=mtxY, lambda
                )
     )
...
# Print the post-optimization cost
nnCost(vecMatrix=nnListCG150$par, nInputLayer, nHiddenNodes, nFinalLabels, X=mtxX, y=mtxY, lambda)
...
# Print the post-optimization cost
nnCost(vecMatrix=nnListCG050$par, nInputLayer, nHiddenNodes, nFinalLabels, X=mtxX, y=mtxY, lambda)
