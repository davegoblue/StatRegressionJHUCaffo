...
pTrain <- apply(dnorm(trainX, mean=muTrain, sd=sigmaTrain), 1, FUN=prod)
...
probCV <- apply(dnorm(cvX, mean=muTrain, sd=sigmaTrain), 1, FUN=prod)  # Use train mu/sigma
...
print(paste0("Best fit found at epsilon: ", round(useEps,8)," driving CV F1=", round(testF1,3)))
