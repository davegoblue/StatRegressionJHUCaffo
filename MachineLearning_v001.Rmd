...
plot(tumorSize, tumorType, xlab="Tumor Size", ylab="Malignant (1=Yes, 0=No)",
     main=paste0("50% Probability at Tumor Size: ",round(keyCutOrig,4)), cex.main=0.85
     )
abline(fakeTumorLMOrig, col="red")
...
plot(tumorSizeMod, tumorTypeMod, xlab="Tumor Size", ylab="Malignant (1=Yes, 0=No)",
     main=paste0("50% Probability at Tumor Size: ",round(keyCutMod,4)), cex.main=0.85
     )
abline(fakeTumorLMMod, col="red")
...
The LM is appropriately responding to the new data by driving up the intercept (more of the data are positive).  But, this means we declare tumors of size 0.011 to have a 50% chance of being malignant, even though we know from the closed form that the probability of malignancy at 0.011 should be ~20%.