...
* The sum of the first n $d^2 divided by the total sum($d^2) describes the total variance captured by the first n principal components  
* X = U % * % diag(D) % * % t(V)  
* D = t(U) % * % X % * % V
...
uReduce <- svdColors$u[,1,drop=FALSE]
```
